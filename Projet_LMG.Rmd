...
Testons les corrélations entre les variables de nébulosités, de vitesses de vent, de directions du vent.
...
choixman_mod1=regsubsets(pluie.demain.bin~Pressure.mean+Precip.tot+Humid.mean+TotalCloud.mean+WindSpeed10m.mean+WindDir10m.mean+Sunshine.tot,int=T,nbest=1,nvmax=7,method="exhaustive",data=d.train[train_80,])
...
choixman_mod2=regsubsets(pluie.demain.bin~Pressure.mean+Precip.tot+Humid.mean+TotalCloud.mean+WindSpeed900mb.mean+WindDir900mb.mean,int=T,nbest=1,nvmax=6,method="exhaustive",data=d.train[train_80,])
...
choixman_mod3=regsubsets(pluie.demain.bin~Pressure.mean+TotalCloud.mean+WindSpeed900mb.max+WindDir900mb.mean,int=T,nbest=1,nvmax=4,method="exhaustive",data=d.train[train_80,])
...
# descendante
# step(glm(pluie.demain.bin~Pressure.mean+TotalCloud.mean+WindSpeed900mb.max+WindDir900mb.mean,data=d.train,family=binomial),data=d[train_80, ],direction="backward")

#progressive
step(glm(pluie.demain.bin~1,data=d.train[train_80,],family=binomial),pluie.demain.bin~Pressure.mean+TotalCloud.mean+WindSpeed900mb.max+WindDir900mb.mean,data=d.train[train_80,],direction="both")

mod3=glm(pluie.demain.bin~Pressure.mean+TotalCloud.mean+WindSpeed900mb.max+WindDir900mb.mean,data=d.train[train_80,],family=binomial)
...
mod0=glm(pluie.demain.bin~1,data=d.train[train_80,],family=binomial)
#aic
aic_mod0=AIC(mod0)
#deviance nulle
...
```{r choixprog_mod1}
# modèle 1
step(glm(pluie.demain.bin~1,data=d.train[train_80,],family=binomial),pluie.demain.bin~Pressure.mean+Precip.tot+Humid.mean+TotalCloud.mean+WindSpeed10m.mean+WindDir10m.mean+Sunshine.tot,direction="both")

mod1=glm(pluie.demain.bin~Pressure.mean+Precip.tot+Humid.mean+TotalCloud.mean+WindSpeed10m.mean+WindDir10m.mean+Sunshine.tot,data=d.train[train_80,],family=binomial)
...
step(glm(pluie.demain.bin~1,data=d.train[train_80,],family=binomial),pluie.demain.bin~Pressure.mean+TotalCloud.mean+WindSpeed900mb.max+WindDir900mb.mean+Humid.mean,direction="both")

mod4=glm(pluie.demain.bin~Pressure.mean+TotalCloud.mean+WindSpeed900mb.max+WindDir900mb.mean+Humid.mean,data=d.train[train_80,],family=binomial)
...
#progressive
step(glm(pluie.demain.bin~1,data=d.train[train_80,],family=binomial),pluie.demain.bin~Pressure.mean+TotalCloud.mean+WindSpeed900mb.max+WindDir900mb.mean+Temp.mean,data=d.train[train_80,],direction="both")

mod5=glm(pluie.demain.bin~Pressure.mean+TotalCloud.mean+WindSpeed900mb.max+WindDir900mb.mean+Temp.mean,data=d.train[train_80,],family=binomial)
...
step(glm(pluie.demain.bin~1,data=d.train[train_80,],family=binomial),pluie.demain.bin~Pressure.mean+TotalCloud.mean+WindDir900mb.mean,data=d.train[train_80,],direction="both")

mod6=glm(pluie.demain.bin~Pressure.mean+TotalCloud.mean+WindDir900mb.mean,data=d.train[train_80,],family=binomial)
