...
choixman_mod1=regsubsets(pluie.demain~Pressure.mean+Precip.tot+Humid.mean+TotalCloud.mean+WindSpeed10m.mean+WindDir10m.mean+Sunshine.tot,int=T,nbest=1,nvmax=7,method="exhaustive",data=d.train)
...
choixman_mod2=regsubsets(pluie.demain~Pressure.mean+Precip.tot+Humid.mean+TotalCloud.mean+WindSpeed900mb.mean+WindDir900mb.mean,int=T,nbest=1,nvmax=6,method="exhaustive",data=d.train)
...
choixman_mod3=regsubsets(pluie.demain~Pressure.mean+TotalCloud.mean+WindSpeed900mb.max+WindDir900mb.mean,int=T,nbest=1,nvmax=4,method="exhaustive",data=d.train)
...
# descendante
# step(glm(pluie.demain~Pressure.mean+TotalCloud.mean+WindSpeed900mb.max+WindDir900mb.mean,data=d.train,family=binomial),data=d.train,direction="backward")

#progressive
step(glm(pluie.demain~1,data=d.train,family=binomial),pluie.demain~Pressure.mean+TotalCloud.mean+WindSpeed900mb.max+WindDir900mb.mean,data=d.train,direction="both")

mod3=glm(pluie.demain~Pressure.mean+TotalCloud.mean+WindSpeed900mb.max+WindDir900mb.mean,data=d.train,family=binomial)
summary (mod3)
...
```{r choixprog_mod1}
# modèle 1
step(glm(pluie.demain~1,data=d.train,family=binomial),pluie.demain~Pressure.mean+Precip.tot+Humid.mean+TotalCloud.mean+WindSpeed10m.mean+WindDir10m.mean+Sunshine.tot,direction="both")

mod1=glm(pluie.demain~Pressure.mean+Precip.tot+Humid.mean+TotalCloud.mean+WindSpeed10m.mean+WindDir10m.mean+Sunshine.tot,data=d.train,family=binomial)
summary(mod1)

```

**Modèle 4** : nouveau modèle à 6 variables explicatives . Il combine le modèle 3 en ajoutant Precip.tot et Humid.mean

```{r choixprog_mod4}
# modèle 4
step(glm(pluie.demain~1,data=d.train,family=binomial),pluie.demain~Pressure.mean+TotalCloud.mean+WindSpeed900mb.max+WindDir900mb.mean+Precip.tot+Humid.mean,direction="both")

mod4=glm(pluie.demain~Pressure.mean+TotalCloud.mean+WindSpeed900mb.max+WindDir900mb.mean+Precip.tot+Humid.mean,data=d.train,family=binomial)
summary(mod4)

```
 - **Modèle 5** : 4 variables explicatives modele 3
    (presssion moyenne, nébulosité totale, vitesse maximum du vent et direction du vent à 900hPA)
...
mod5=glm(pluie.demain~Pressure.mean+TotalCloud.mean+WindSpeed900mb.max+WindDir900mb.mean,data=d.train,family=binomial)
summary (mod5)
...
# Prévsion de la météo du lendemain 
